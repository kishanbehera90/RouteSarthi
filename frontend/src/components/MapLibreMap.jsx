...
// Free/open fallback map (MapLibre + OpenFreeMap). Used when no Mappls key is
// configured, or if the Mappls SDK fails to load. Coordinates are [lng, lat].
...
export default function MapLibreMap({ legs, className = '', live = false, liveProgress = 0 }) {
